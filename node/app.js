class App {
  ...
  requireModules(){
    ...
    // SqlRouter is a class that lets us do SQL queries
    // by scanning client side classes and setting up
    // routes to the frontend
    this.SqlRouter = require('./sql-router.class.js');
  ...
  createWebServer(){
    ...
    // A loader for clientside static sqlRouter
    new this.SqlRouter(server);
